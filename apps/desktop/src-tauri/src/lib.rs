...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            agent_registry_list,
            agent_registry_use_system,
            agent_registry_install,
            agent_registry_update,
            agent_connections_list,
            agent_connections_restart,
            agent_login,
            agent_login_terminal_output,
            agent_login_terminal_write,
            agent_login_terminal_cancel,
            agent_logout,
            agent_stderr,
            ...
            thread_respond_extension,
            thread_provider_control,
            thread_delete_provider_session,
            thread_fork,
            thread_archive,
            thread_delete,
