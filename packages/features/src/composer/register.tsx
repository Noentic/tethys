//! Registers the composer's context-bar slots at feature-module scope (A1), so
...
export function registerComposerSlots(): void {
  ...
  // `mode` is the shell's declared registry seam (CONTEXT_BAR_PRIORITY.mode).
  registerComposerContextSlot("mode", ModePill, MODE_PILL_PRIORITY);
}
