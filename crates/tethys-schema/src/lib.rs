...
pub fn registered_types() -> Types {
    Types::default()
        ...
        .register::<agents::AgentLoginInput>()
        .register::<agents::AgentLoginOutcome>()
        .register::<agents::LoginTerminalOutput>()
        ...
        .register::<thread::ProviderControl>()
        .register::<thread::ProviderControlResult>()
        .register::<thread::ProviderHeader>()
        .register::<thread::ProviderRoute>()
        .register::<thread::ProviderRouteConfig>()
        .register::<thread::GoalAction>()
        .register::<thread::SteeringOutcome>()
        .register::<thread::FileChangeReport>()
        .register::<thread::DiffStatistics>()
        .register::<thread::ThreadSummary>()
        .register::<thread::ThreadSessionView>()
        .register::<thread::ProviderSessionSummary>()
        .register::<thread::ProviderSessionPage>()
