...
pub trait TethysApi: Send + Sync {
    ...
    fn project_settings_get(&self) -> impl std::future::Future<Output = Result<(), ApiError>> + Send {
        async { Err(ApiError::Unimplemented("project.settings_get")) }
    }
    fn project_settings_set(&self) -> impl std::future::Future<Output = Result<(), ApiError>> + Send {
    ...
    // === agent ===
    fn agent_profiles_list(&self) -> impl std::future::Future<Output = Result<(), ApiError>> + Send {
        async { Err(ApiError::Unimplemented("agent.profiles_list")) }
    }
    fn agent_profiles_create(&self) -> impl std::future::Future<Output = Result<(), ApiError>> + Send {
        async { Err(ApiError::Unimplemented("agent.profiles_create")) }
    }
    fn agent_profiles_update(&self) -> impl std::future::Future<Output = Result<(), ApiError>> + Send {
        async { Err(ApiError::Unimplemented("agent.profiles_update")) }
    }
    fn agent_profiles_delete(&self) -> impl std::future::Future<Output = Result<(), ApiError>> + Send {
        async { Err(ApiError::Unimplemented("agent.profiles_delete")) }
    }
    fn agent_registry_list(&self) -> impl std::future::Future<Output = Result<(), ApiError>> + Send {
        async { Err(ApiError::Unimplemented("agent.registry_list")) }
    }
    fn agent_registry_install(&self) -> impl std::future::Future<Output = Result<(), ApiError>> + Send {
        async { Err(ApiError::Unimplemented("agent.registry_install")) }
    }
    fn agent_registry_update(&self) -> impl std::future::Future<Output = Result<(), ApiError>> + Send {
        async { Err(ApiError::Unimplemented("agent.registry_update")) }
    }
    fn agent_connections_list(&self) -> impl std::future::Future<Output = Result<(), ApiError>> + Send {
        async { Err(ApiError::Unimplemented("agent.connections_list")) }
    }
    fn agent_connections_restart(&self) -> impl std::future::Future<Output = Result<(), ApiError>> + Send {
    ...
    fn agent_config_schema(&self) -> impl std::future::Future<Output = Result<(), ApiError>> + Send {
    ...
    fn agent_config_validate(&self) -> impl std::future::Future<Output = Result<(), ApiError>> + Send {
    ...
    fn agent_config_rollback(&self) -> impl std::future::Future<Output = Result<(), ApiError>> + Send {
        async { Err(ApiError::Unimplemented("agent.config_rollback")) }
    }

    // === thread ===
    fn thread_create(&self) -> impl std::future::Future<Output = Result<(), ApiError>> + Send {
        async { Err(ApiError::Unimplemented("thread.create")) }
    }
    fn thread_list(&self) -> impl std::future::Future<Output = Result<(), ApiError>> + Send {
        async { Err(ApiError::Unimplemented("thread.list")) }
    }
    fn thread_get(&self) -> impl std::future::Future<Output = Result<(), ApiError>> + Send {
        async { Err(ApiError::Unimplemented("thread.get")) }
    }
    fn thread_prompt(&self) -> impl std::future::Future<Output = Result<(), ApiError>> + Send {
    ...
    fn thread_queue_remove(&self) -> impl std::future::Future<Output = Result<(), ApiError>> + Send {
        async { Err(ApiError::Unimplemented("thread.queue_remove")) }
    }
    fn thread_queue_reorder(&self) -> impl std::future::Future<Output = Result<(), ApiError>> + Send {
        async { Err(ApiError::Unimplemented("thread.queue_reorder")) }
    }
    fn thread_cancel(&self) -> impl std::future::Future<Output = Result<(), ApiError>> + Send {
        async { Err(ApiError::Unimplemented("thread.cancel")) }
    }
    fn thread_resume(&self) -> impl std::future::Future<Output = Result<(), ApiError>> + Send {
        async { Err(ApiError::Unimplemented("thread.resume")) }
    }
    fn thread_import_sessions(&self) -> impl std::future::Future<Output = Result<(), ApiError>> + Send {
    ...
    fn thread_archive(&self) -> impl std::future::Future<Output = Result<(), ApiError>> + Send {
        async { Err(ApiError::Unimplemented("thread.archive")) }
    }
    fn thread_delete(&self) -> impl std::future::Future<Output = Result<(), ApiError>> + Send {
        async { Err(ApiError::Unimplemented("thread.delete")) }
    }
    fn thread_set_config_option(&self) -> impl std::future::Future<Output = Result<(), ApiError>> + Send {
        async { Err(ApiError::Unimplemented("thread.set_config_option")) }
    }
    fn thread_set_permission_mode(&self) -> impl std::future::Future<Output = Result<(), ApiError>> + Send {
        async { Err(ApiError::Unimplemented("thread.set_permission_mode")) }
    }

    // === events ===
    fn events_subscribe(&self) -> impl std::future::Future<Output = Result<(), ApiError>> + Send {
        async { Err(ApiError::Unimplemented("events.subscribe")) }
    }
    fn events_unsubscribe(&self) -> impl std::future::Future<Output = Result<(), ApiError>> + Send {
        async { Err(ApiError::Unimplemented("events.unsubscribe")) }
    }
    fn events_inbox_subscribe(&self) -> impl std::future::Future<Output = Result<(), ApiError>> + Send {
    ...
    fn permission_rules_list(&self) -> impl std::future::Future<Output = Result<(), ApiError>> + Send {
        async { Err(ApiError::Unimplemented("permission.rules_list")) }
    }
    fn permission_rules_set(&self) -> impl std::future::Future<Output = Result<(), ApiError>> + Send {
        async { Err(ApiError::Unimplemented("permission.rules_set")) }
    }
    fn permission_rules_delete(&self) -> impl std::future::Future<Output = Result<(), ApiError>> + Send {
    ...
    fn mcp_registry_delete(&self) -> impl std::future::Future<Output = Result<(), ApiError>> + Send {
    ...
    fn mcp_projection_plan(&self) -> impl std::future::Future<Output = Result<(), ApiError>> + Send {
        async { Err(ApiError::Unimplemented("mcp.projection_plan")) }
    }
    fn mcp_projection_apply(&self) -> impl std::future::Future<Output = Result<(), ApiError>> + Send {
        async { Err(ApiError::Unimplemented("mcp.projection_apply")) }
    }
    fn mcp_projection_rollback(&self) -> impl std::future::Future<Output = Result<(), ApiError>> + Send {
    ...
    fn skills_update_check(&self) -> impl std::future::Future<Output = Result<(), ApiError>> + Send {
        async { Err(ApiError::Unimplemented("skills.update_check")) }
    }
    fn skills_update_apply(&self) -> impl std::future::Future<Output = Result<(), ApiError>> + Send {
